...
#include <memory>
#include "../../Aqr_Software_Proyecto/menuprincipal.h"
...
QT_MOC_LITERAL(3, 20, 21) // "on_pushButton_clicked"
    ...
    "menuPrincipal\0back\0\0on_pushButton_clicked"
};
...
void menuPrincipal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (menuPrincipal::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&menuPrincipal::back)) {
                *result = 0;
                return;
            }
        }
